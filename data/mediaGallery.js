$(document).ready(function () {
  ...
  for (let i = 1; i <= 20; i++) {
    ...
    mediaGalleryDay1Data.push({
      img: `http://82.112.226.178/images/media_gallery/day1/${i}.webp`,
  ...
  for (let i = 1; i <= 78; i++) {
    ...
    mediaGalleryDay2Data.push({
      img: `http://82.112.226.178/images/media_gallery/day2/${i}.webp`,
      className: sequentialClass,
    });
  }
  ...
  for (let i = 1; i <= 32; i++) {
    ...
    mediaGalleryDay3Data.push({
      img: `http://82.112.226.178/images/media_gallery/day3/${i}.webp`,
      className: sequentialClass,
    });
  }
